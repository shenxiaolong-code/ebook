<!--[346,1,680] published at 2009-06-22 18:29:47 from #221 by 1430-->
/**---------------------------------------------------------------------------
* browser determine;
*/
...
function PopUp(id, config){
	...
	this.imgMin1 = "http://i2.sinaimg.cn/blog/mini/08olympic/blogrecommend_hz_004.gif";
	this.imgMin2 = "http://i1.sinaimg.cn/blog/mini/08olympic/yzq_001.gif";
...
function job(){
	...
	*/
	...
	//ant-显示和初始化放到了一起了，主要是防止有时不显示mini窗口也加载页面
	function initPopUp(){
...
function doit(){
	if("1608573654" == scope.$uid || "1620559227" == scope.$uid){
		//http://blog.sina.com.cn/gavinnewsom ����ʾ�����ݡ�
		return;
	}
	if($IE){
